...
The Central Supply Catalog separates software licensing from catalog content licensing. The source code is licensed under the Apache License, Version 2.0. Catalog data, product descriptions, images, setting references, and other Traveller-related content are licensed or used separately under the terms described in the repository's LICENSE-CONTENT.md and NOTICE.md files.

The Apache-2.0 code license does not grant any rights to Traveller content, trademarks, images, or other third-party material. The author makes no claim for content owned by others.
...
Far Future Enterprises <a href="https://farfuture.net" target="_blank">Far Future Enterprises, Inc.</a>. Marc Miller's publishing site for the Traveller CD-ROMS.
