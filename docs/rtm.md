...
| FR-005 Full-text search | `docs/design.md`, `docs/site-search.md` | `astro/components/SearchResults.vue`, `astro/lib/searchIndexClient.js`, `astro/lib/catalog.mjs` | TST-002, TST-006 |
...
| FR-012 Support/about/licensing content | `docs/design.md` | `astro/content/pages/`, `astro/pages/support.astro`, `astro/pages/about-the-central-supply-catalog.astro` | TST-001, TST-009 |
